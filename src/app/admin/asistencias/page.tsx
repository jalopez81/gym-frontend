    ...
    const columnas: GridColDef<Asistencia>[] = [
        {
            ...
            headerName: 'Cliente',
            flex: 1,
            valueGetter: (_value, row: Asistencia) => row.cliente?.nombre ?? 'Sin nombre',
        ...
        },
        {
            ...
            headerName: 'Clase',
            flex: 1,
            valueGetter: (_value, row: Asistencia) => row.sesion?.clase?.nombre ?? 'Sin nombre',
        ...
        },
        {
            ...
            headerName: 'Sesión',
            flex: 1,
            valueGetter: (_value, row: Asistencia) => formatDateTime(row.sesion?.fechaHora) ?? 'Sin fecha',
        ...
        { field: 'estado', headerName: 'Estado', flex: 1 },
        {
            ...
            flex: 1,
            valueGetter: (_value, row: Asistencia) => formatDateTime(row.horaEntrada) ?? 'Sin hora',
